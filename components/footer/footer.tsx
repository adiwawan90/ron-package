...
const Logo = () => {
  return (
    <Image src={"/assets/rons-logo.png"} alt={"logo"} width={133} height={28} />
  );
};
      ...
      <Container as={Stack} maxW={"6xl"} py={10} fontSize={"14px"}>
        ...
        >
          <Stack spacing={6}>
            ...
            <Text fontSize={"sm"}>Rons Packaging</Text>
            <Text fontSize={"sm"}>
              Jl. Sawo II No Kampung II Jakasampurna, Bekasi Barat.
            </Text>
            <Text fontSize={"sm"}>
              © 2020 - {new Date().getFullYear()} | Rons Packaging <br />
            </Text>
          </Stack>
          ...
          <Stack align={"flex-start"}>
            ...
            <SmoothScrollLink targetId={"#products"}>
              <Text>Product</Text>
            </SmoothScrollLink>
          </Stack>
          <Stack align={"flex-start"} gap={1} id={"contact"}>
            <ListHeader>Hubungi Kami</ListHeader>
            <HStack>
              <WhatsappFillIcon />
              <a
                href={
                  "https://api.whatsapp.com/send/?phone=6285711322464&text&type=phone_number&app_absent=0"
                }
                target="_blank"
              >
                +6285711322464
            ...
            <HStack>
              ...
              <a target="_blank" href={"mailto:serpul@yuscorp.co.id"}>
                rons.printandpackage@gmail.com
              </a>
            </HStack>
            {/* <HStack gap={"24px"}>
