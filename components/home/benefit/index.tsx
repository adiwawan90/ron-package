...
const data = [
  ...
  {
    title: "Bebas Costum Package",
    image: "/assets/lp/benefit/ben-1.png",
    description:
      "Buat kemasan dengan merek, logo,icon, dan warna yang dapat kamu costum sendiri",
  },
  // {
  ...
  // },
  {
    title: "Melayani Percetakan",
    image: "/assets/lp/benefit/ben-10.png",
    description:
      "Tersedia beragam produk percetakan menarik yang siap digunakan untuk kebutuhan bisnismu",
  },
];
  ...
  return (
    <Box pb={"30px"} id={"benefit"}>
      <Center flexDirection={"column"} pt={"100px"}>
        ...
        >
          Kami telah berpengalaman Lebih dari 5 Tahun dan 1.000+ pelanggan telah
          mempercayakan packaging produk mereka.
        </Text>
      </Center>
