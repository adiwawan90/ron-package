        ...
        <Center flexDirection={"column"} pt={"50px"} pb={"84px"}>
          ...
          >
            <Text fontSize={{ base: "25px", md: "28px" }} textAlign={"center"}>
              Membantu Menemukan Packaging Untukmu.
              {/* <Text
                as={"span"}
          ...
          <Flex>
            ...
            >
              ...
              hadir untuk temukan packaging yang sesuai untuk produkmu, menambah
              nilai dan meningkatkan kualitas jualanmu.
            </Text>
          </Flex>
